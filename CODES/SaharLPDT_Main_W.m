...
%     writetable(T3,fullfile(path_Val,'Qfilter.txt'),'Delimiter','\t','WriteRowNames',false);
    ...
    if isempty(fsd)==1
        maxnorm =mean(AppQ.Mode.StressDrop_MPa); 
    else
...
saveas(gca,fullfile(path_Reg,'App2_Mode.fig'));
close
end
......
...........................................................................
...
%     writetable(T3,fullfile(path_Val,'Qfilter.txt'),'Delimiter','\t','WriteRowNames',false);
    ...
    fsd=find((h(2).YData>= max(h(2).YData)));
    if isempty(fsd)==1
        maxnorm =mean(AppQ.Curvature.StressDrop_MPa); 
    else
        maxnorm =10.^(h(2).XData(fsd(1)));
        xline(h(2).XData(fsd(1)),'Linewidth',2,'color',[.6 .6 .6])
    end
...
saveas(gca,fullfile(path_Reg,'App2_Carvature.fig'));
close
end
...........................................................................
if (strcmp(QFilter,'on')==1)
...
if (size(coefE,2)~=1)
    ...
    saveas(figure (1),fullfile(path_Fig,'App1-MinSD.png'));
    close
end
...........................................................................
